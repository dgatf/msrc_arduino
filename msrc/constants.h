...
/* Init debug port */
#if defined(DEBUG) || defined(DEBUG_PACKET) || defined(DEBUG_SBUS_MS) || defined(DEBUG_EEPROM_WRITE) || defined(DEBUG_EEPROM_READ) || defined(DEBUG_GPS) || defined(DEBUG_HW3) || defined(DEBUG_HW4) || defined(DEBUG_PWM) || defined(DEBUG_CASTLE) || defined(DEBUG_CASTLE_RX) || defined(DEBUG_KONTRONIK) || defined(DEBUG_APDF) || defined(DEBUG_APDHV) || defined(DEBUG_MS5611) || defined(DEBUG_APDF_PACKET)
...
#if CONFIG_ESC_PROTOCOL == PROTOCOL_HW_V3 || CONFIG_ESC_PROTOCOL == PROTOCOL_HW_V4 || CONFIG_ESC_PROTOCOL == PROTOCOL_KONTRONIK || CONFIG_ESC_PROTOCOL == PROTOCOL_APD_F || CONFIG_ESC_PROTOCOL == PROTOCOL_APD_HV || CONFIG_GPS
